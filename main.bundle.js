            ...
            if (this.style) {
                ...
                this.data.setStyle(function (feature) {
                    ...
                    return {
                        ...
                        strokeWeight: 1,
                        strokeOpacity: 0.2,
                        icon: "/edom/assets/icon_" + o_1[feature.getProperty(p_1)] + "_dot.png",
                        visible: visible
                    };
                });
            }
